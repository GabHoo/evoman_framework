...
pop_size = 2  # quantity of the population - number of chromosomes in our population, not changing during the experiment.
n_offspring = 4 # this might be a big number 
